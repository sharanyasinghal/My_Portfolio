      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-6 md:mb-0">
            <h2 className="text-2xl font-bold text-white">Sharanya Singhal</h2>
            <p className="mt-2">Pre-Final year Engineering Student</p>
          </div>
          ...
          <div className="flex space-x-6">
            ...
            <a href="https://www.linkedin.com/in/sharanya-singhal-92abb129a/" target="_blank" rel="noopener noreferrer" className="hover:text-blue-400 transition-colors duration-300">
              <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
